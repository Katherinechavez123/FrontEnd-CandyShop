  ...
  return (
    <div className="fondito">
      <div className="relative isolate px-6 pt-14 lg:px-8">
        <div
          className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hiden blur-3xl sm:-top-80"
          aria-hidden="true"
        >
          <div
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl font-CandyLove">
